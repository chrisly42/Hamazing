...
vc -g -hunkdebug -O2 -notmpfile -nostdlib -o "gotham.exe" "gotham.asm"

copy gotham.exe "..\winuae\hd0"
copy gotham.exe "..\winuae\hd0\a"

copy "..\winuae\hd0\s\debug-sequence" "..\winuae\hd0\s\startup-sequence"
@echo /|set /p =gotham.exe >>"..\winuae\hd0\s\startup-sequence"
